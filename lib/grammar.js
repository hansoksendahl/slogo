...
var grammar = {
  ...
  'bnf': helpers.bnf({
    ...
    'Statement.Alteration.Oneliner': [
      'VAR.ALTERATION Assignment.Member', '{name: "Assign", value: [$2]}'
    ],
    ...
    'Statement.IfThenElse': [
      ...
      'LOGIC.IF Expression.Conditional LOGIC.THEN Nl If.Member LOGIC.ELSE Statement.Oneliner PROC.END Nl', '{name: "IfElse", value: [$2, $5, $7]}',
