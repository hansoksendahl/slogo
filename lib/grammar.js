...
var grammar = {
  ...
  'bnf': helpers.bnf({
    ...
    // ### Ranges
    'Type.Range': [
      'RANGE.INCLUSIVE', '{name: "Range", value: $1.slice(1, -1).split("..")}',
      'RANGE.EXCLUSIVE', '{name: "Range", exclusive: true, value: $1.slice(1, -1).split("...")}'
    ],
    ...
    'Statement.Alteration': [
      'VAR.ALTERATION Assignment.List Nl', '{name: "Assign", value: $2}',
    ],
    ...
    'Assignment.Member': [
      'Expression.Left VAR.ASSIGN Expression.Conditional', '[$1, $3]'
    ],
    ...
    'Statement.Return': [
      ...
      // 'PROC.RETURN Expression.Conditional Nl', '{name: "Return", value: $2}'
    ],
    ...
    'Logic.And': [
      'Math.Equality', '$1',
      '<this> LOGIC.AND Math.Equality', 'yy.Logic.and($1, $3)'
    ],

      'Logic.And.Lambda': [
        'Math.Equality.Lambda', '$1',
        '<this> LOGIC.AND Math.Equality.Lambda', 'yy.Logic.and($1, $3)'
      ],
    ...
    'Statement.IfThenElse': [
      ...
      'LOGIC.IF Expression.Conditional LOGIC.THEN Nl If.Member LOGIC.ELSE If.Member PROC.END Nl', '{name: "IfElse", value: [$2, $5, $7]}',
      'LOGIC.IF Expression.Conditional LOGIC.THEN If.Member LOGIC.ELSE Nl If.Member PROC.END Nl', '{name: "IfElse", value: [$2, $4, $7]}',
      'LOGIC.IF Expression.Conditional LOGIC.THEN If.Member LOGIC.ELSE If.Member PROC.END Nl', '{name: "IfElse", value: [$2, $4, $6]}'
    ],
    
    'Statement.IfThen': [
      'LOGIC.IF Expression.Conditional LOGIC.THEN If.Member PROC.END Nl', '{name: "IfElse", value: [$2, $4, null]}',
    ...
    'Proc.Assignment': [
      ...
      'PROC.NAMED Proc.FormalParameterList Nl Block PROC.END', '{name: "Assign", newScope: true, value: [[yy.Literal.strip($1), {name: "Procedure", value: $4, arguments: $3}]]}',
    ],
    ...
    'Proc.Class': [
      ...
      'PROC.CLASS OBJECT.EXTENDS Nl Block PROC.END', '{name: "Class", value: [yy.Literal.strip($1), $4], extends: yy.Literal.strip($3)}'
    ],
