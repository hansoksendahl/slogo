...
var alternates = function(args) {
  ...
  for (var i = 0; i < args.length; i = i + 2) {
    var
      symbol     = args[i],
      ExprStatement = args[i+1].replace(regex, '\$yy.');
...
var bnf = function(productions) {
  ...
  for (var token in productions) {
    list[token] = alternates(productions[token]);
  };
  return list
}
...
var grammar = {
  ...
  'bnf': bnf({
    'Program': [
      'Statement EOF',                      '$1; return $1'
    ],
    'SourceElements': [
      'Statement',                          '$1',
      'SourceElements Statement',           '$1'
    ],
    'FunctionBody': [
      'SourceElements',                     '$1'
    ],
    ...
    // ],
    'ExprStatement': [
      'ExprStatement BITWISEOPERATOR Data', '$yy[$2]($1, $3)',
      'ExprStatement + Data',               '$1 + $3',
      'ExprStatement - Data',               '$1 - $3',
      'ExprStatement * Data',               '$1 * $3',
      'ExprStatement / Data',               '$1 / $3',
      'ExprStatement ^ Data',               'Math.pow($1, $3)',
      'ExprStatement MODULUS Data',         '$1 % $3',
      'MATHCONSTANT',                       '$.Math[$1]',
      '( ExprStatement )',                  '$2',
      'ExprStatement %',                    '$1 / 100',
      'ExprStatement !',                    '$.Math.factorial($1)',
      'MATHFUNCTION ArgumentList',          '$.Math[$1].apply(null, $2);',
      'Data',                               '$1'
    ],
    'Data': [
      'NUMBER',                             'Number($1)'
    ...
    'ArgumentList': [
      'Statement',                          '[$1]',
      'ArgumentList , Statement',           '$1.concat($3)'
    ]
  })
};
