...
var alternates = function(args) {
  ...
  for (var i = 0; i < args.length; i = i + 2) {
    var
      symbol     = args[i],
      expression = args[i+1].replace(regex, '\$yy.');
...
var grammar = {
  ...
  'lex': {
    ...
    'macros': {
      ...
      'mExt': 'difference|mean|median|mode|product|quotient|range|sum'
    },
    // ### Rules
  ...
  'bnf': bnf({
    ...
    'EXPRESSION': [
      'EXPRESSION BITWISEOPERATOR EXPRESSION': '$yy[$2]($1, $3)',
