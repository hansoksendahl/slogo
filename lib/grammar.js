...
var grammar = {
  ...
  'bnf': helpers.bnf({
    ...
    'Statement.IfThenElse': [
      ...
      'LOGIC.IF Expression.Conditional LOGIC.THEN Statement.Expression LOGIC.ELSE Nl If.Member PROC.END Nl', '{name: "IfElse", value: [$2, $4, $7]}',
      'LOGIC.IF Expression.Conditional LOGIC.THEN Nl If.Member LOGIC.ELSE Statement.Expression PROC.END Nl', '{name: "IfElse", value: [$2, $5, $7]}',
      'LOGIC.IF Expression.Conditional LOGIC.THEN Statement.Expression LOGIC.ELSE Statement.Expression PROC.END Nl', '{name: "IfElse", value: [$2, $4, $6]}'
    ],
    
    'Statement.IfThen': [
      'LOGIC.IF Expression.Conditional LOGIC.THEN Statement.Expression PROC.END Nl', '{name: "IfElse", value: [$2, $4, null]}',
